...
operation_parameters_minimum_occurrences["updatePetWithForm:::body"]=0
...
operation_parameters_minimum_occurrences["uploadFile:::body"]=0
operation_parameters_minimum_occurrences["placeOrder:::body"]=1
operation_parameters_minimum_occurrences["getOrderById:::orderId"]=1
...
operation_parameters_maximum_occurrences["updatePetWithForm:::body"]=0
...
operation_parameters_maximum_occurrences["getOrderById:::orderId"]=0
...
operation_parameters_collection_type["findPetsByStatus:::status"]=""
operation_parameters_collection_type["findPetsByTags:::tags"]=""
operation_parameters_collection_type["getPetById:::petId"]=""
operation_parameters_collection_type["updatePetWithForm:::petId"]=""
operation_parameters_collection_type["updatePetWithForm:::body"]=""
...
${BOLD}${WHITE}Swagger Petstore command line client (API version 1.0.0)${OFF}
...
EOF
    ...
    echo -e "        * http://petstore.swagger.io/oauth/dialog"
    echo -e "      Scopes:"
    echo -e "        * write:pets - "
    echo -e "        * read:pets - "
...
print_version() {
    echo ""
    echo -e "${BOLD}Swagger Petstore command line client (API version 1.0.0)${OFF}"
    echo ""
}
...
print_addPet_help() {
    ...
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Pet object that needs to be added to the store" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
...
print_findPetsByStatus_help() {
    ...
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}status${OFF} ${BLUE}[array]${OFF} ${RED}(required)${OFF}${OFF} - Status values that need to be considered for filter${YELLOW} Specify as: status=value${OFF}" \
...
print_findPetsByTags_help() {
    ...
    echo -e ""
    echo -e "Muliple tags can be provided with comma separated strings. Use tag1, tag2, tag3 for testing." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}tags${OFF} ${BLUE}[array]${OFF} ${RED}(required)${OFF}${OFF} - Tags to filter by${YELLOW} Specify as: tags=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_updatePetWithForm_help() {
    ...
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/x-www-form-urlencoded]${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=405
...
print_uploadFile_help() {
    ...
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/octet-stream]${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getOrderById_help() {
    ...
    echo -e ""
    echo -e "For valid response try integer IDs with value >= 1 and <= 10. Other values will generated exceptions" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}orderId${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of pet that needs to be fetched ${YELLOW}Specify as: orderId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
    echo -e "${result_color_table[${code:0:1}]}  200;successful operation${OFF}" | paste -sd' ' | column -t -s ';' | fold -sw 80 | sed '2,$s/^/       /'
...
print_deleteOrder_help() {
    ...
    echo -e ""
    echo -e "For valid response try integer IDs with positive integer value. Negative or non-integer values will generate API errors" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}orderId${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the order that needs to be deleted ${YELLOW}Specify as: orderId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=400
    echo -e "${result_color_table[${code:0:1}]}  400;Invalid ID supplied${OFF}" | paste -sd' ' | column -t -s ';' | fold -sw 80 | sed '2,$s/^/       /'
...
print_createUser_help() {
    ...
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=default
    echo -e "${result_color_table[${code:0:1}]}  default;successful operation${OFF}" | paste -sd' ' | column -t -s ';' | fold -sw 80 | sed '2,$s/^/       /'
}
##############################################################################
#
...
print_updateUser_help() {
    ...
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}username${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - name that need to be updated ${YELLOW}Specify as: username=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
call_uploadFile() {
    ...
    if [[ -z $header_content_type && "$force" = false ]]; then
        ...
        echo "ERROR: Request's content-type not specified!!!"
        echo "This operation expects content-type in one of the following formats:"
        echo -e "\\t- application/octet-stream"
        echo ""
        echo "Use '--content-type' to set proper content type"
        exit 1
    else
...
call_getOrderById() {
    ...
    if ! path=$(build_request_path "/v2/store/order/{orderId}" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="GET"
