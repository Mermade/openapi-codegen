...
# ! Installation:
# !
# ! Copy the _bash_completion.sh file to any directory under FPATH
...
case $state in
  ops)
    ...
    _values "Operations" \
            ...
            "uploadFile[uploads an image]"             "getInventory[Returns pet inventories by status]" \
            "placeOrder[Place an order for a pet]" \
            "getOrderById[Find purchase order by ID]" \
            "deleteOrder[Delete purchase order by ID]"             "createUser[Create user]" \
