...
--[[
Unit tests for openapi.model.Order
...
describe("Order", function()
  ...
  -- unit tests for the property 'petId'
  describe("property petId test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  -- unit tests for the property 'shipDate'
  describe("property shipDate test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
